...
<html>
    <body role="document">
        ...
        <c:if test="${not empty newUser}">
            <h4>Your account name ${newUser.userName} has been created.  Click 'My Dashboard' to sign in now.</h4>
        </c:if>
        ...
        <p>Testing EL Value: ${testing}</p>


        <p>The new user name is ${newUser}</p>
